...
export const metadata: Metadata = {
  title: 'Ledger — Investor Research Desk',
  description: 'Search, review, and export investor research candidates.',
};
    ...
    <html lang="en">
      ...
      <body>
        <header className="topbar">
          ...
          <span className="tagline">Investor research desk</span>
        </header>
        {children}
      </body>
    </html>
